...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		section: "Fossil Fishing",
	},
	{
		name: "[Gen 9] Fossil Fishing",
		mod: 'gen9',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Clause', 'Sleep Clause Mod'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
			'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail',
			'Charmander', 'Charmeleon', 'Charizard', 'Caterpie', 'Metapod',
			'Butterfree', 'Weedle', 'Kakuna', 'Beedrill', 'Pidgey',
			'Pidgeotto', 'Pidgeot', 'Rattata', 'Rattata-Alola', 'Raticate',
			'Raticate-Alola', 'Spearow', 'Fearow', 'Ekans', 'Arbok',
			'Raichu', 'Sandshrew', 'Sandshrew-Alola', 'Sandslash', 'Sandslash-Alola',
			'Nidoran-F', 'Nidorina', 'Nidoqueen', 'Nidoran-M', 'Nidorino',
			'Nidoking', 'Vulpix', 'Vulpix-Alola', 'Ninetales', 'Ninetales-Alola',
			'Jigglypuff', 'Wigglytuff', 'Zubat', 'Golbat', 'Vileplume',
			'Paras', 'Parasect', 'Venonat', 'Venomoth', 'Diglett',
			'Diglett-Alola', 'Dugtrio', 'Dugtrio-Alola', 'Meowth', 'Meowth-Alola',
			'Persian', 'Persian-Alola', 'Mankey', 'Primeape', 'Growlithe',
			'Arcanine', 'Abra', 'Kadabra', 'Alakazam', 'Machop',
			'Machoke', 'Machamp', 'Bellsprout', 'Weepinbell', 'Victreebel',
			'Ponyta', 'Ponyta-Galar', 'Rapidash', 'Rapidash-Galar', 'Magnemite',
			'Magneton', 'Farfetch\u2019d', 'Farfetch\u2019d-Galar', 'Doduo', 'Dodrio',
			'Grimer', 'Grimer-Alola', 'Muk', 'Muk-Alola', 'Gastly',
			'Haunter', 'Gengar', 'Drowzee', 'Hypno', 'Voltorb',
			'Electrode', 'Marowak', 'Hitmonlee', 'Hitmonchan', 'Lickitung',
			'Koffing', 'Weezing', 'Weezing-Galar', 'Rhyhorn', 'Rhydon',
			'Chansey', 'Kangaskhan', 'Mr. Mime', 'Mr. Mime-Galar', 'Scyther',
			'Jynx', 'Electabuzz', 'Magmar', 'Pinsir', 'Tauros',
			'Tauros-Paldea-Combat', 'Tauros-Paldea-Blaze', 'Tauros-Paldea-Aqua',
			'Ditto', 'Jolteon', 'Flareon', 'Porygon', 'Snorlax',
			'Mewtwo', 'Articuno', 'Zapdos', 'Moltres', 'Mewtwo',
			'Cyndaquil', 'Quilava', 'Typhlosion', 'Typhlosion-Hisui', 'Sentret',
			'Furret', 'Hoothoot', 'Noctowl', 'Ledyba', 'Ledian',
			'Spinarak', 'Ariados', 'Crobat', 'Igglybuff', 'Mareep',
			'Flaffy', 'Ampharos', 'Sudowoodo', 'Hoppip', 'Skiploom',
			'Jumpluff', 'Aipom', 'Sunkern', 'Sunflora', 'Espeon',
			'Umbreon', 'Murkrow', 'Misdreavus', 'Wobbuffet', 'Girafarig',
			'Pineco', 'Forretress', 'Snubbull', 'Granbull', 'Scizor',
			'Heracross', 'Sneasel', 'Sneasel-Hisui', 'Skarmory', 'Houndour',
			'Houndoom', 'Phanpy', 'Donphan', 'Porygon2', 'Stantler',
			'Smeargle', 'Tyrogue', 'Hitmontop', 'Smoochum', 'Elekid',
			'Magby', 'Miltank', 'Blissey', 'Raikou', 'Entei',
			'Suicune', 'Lugia', 'Ho-Oh', 'Treecko', 'Grovyle',
			'Sceptile', 'Torchic', 'Combusken', 'Blaziken', 'Poochyena',
			'Mightyena', 'Zigzagoon', 'Zigzagoon-Galar', 'Linoone', 'Linoone-Galar',
			'Wurmple', 'Silcoon', 'Beautifly', 'Cascoon', 'Dustox',
			'Seedot', 'Nuzleaf', 'Shiftry', 'Taillow', 'Swellow',
			'Ralts', 'Kirlia', 'Gardevoir', 'Shroomish', 'Breloom',
			'Slakoth', 'Vigoroth', 'Slaking', 'Nincada', 'Ninjask',
			'Shedinja', 'Whismur', 'Loudred', 'Exploud', 'Makuhita',
			'Hariyama', 'Skitty', 'Delcatty', 'Mawile', 'Meditite',
			'Medicham', 'Electrike', 'Manectric', 'Plusle', 'Minun',
			'Volbeat', 'Illumise', 'Roselia', 'Gulpin', 'Swalot',
			'Numel', 'Camerupt', 'Torkoal', 'Spoink', 'Grumpig',
			'Spinda', 'Swablu', 'Altaria', 'Zangoose', 'Seviper',
			'Castform', 'Shuppet', 'Banette', 'Absol', 'Wynaut',
			'Snorunt', 'Glalie', 'Bagon', 'Shelgon', 'Salamence',
			'Kyogre', 'Groudon', 'Rayquaza', 'Deoxys', 'Deoxys-Attack',
			'Turtwig', 'Grotle', 'Torterra', 'Chimchar', 'Monferno',
			'Infernape', 'Starly', 'Staravia', 'Staraptor', 'Kricketot',
			'Kricketune', 'Shinx', 'Luxio', 'Luxray', 'Budew',
			'Roserade', 'Burmy-Plant', 'Burmy-Trash', 'Wormadam-Plant', 'Wormadam-Trash',
			'Mothim', 'Combee', 'Vespiquen', 'Pachirisu', 'Cherubi',
			'Cherrim', 'Ambipom', 'Drifloon', 'Drifblim', 'Buneary',
			'Lopunny', 'Mismagius', 'Honchkrow', 'Glameow', 'Purugly',
			'Stunky', 'Skuntank', 'Bonsly', 'Mime Jr.', 'Happiny',
			'Chatot', 'Munchlax', 'Riolu', 'Lucario', 'Snover',
			'Abomasnow', 'Weavile', 'Magnezone', 'Lickilicky', 'Rhyperior',
			'Electivire', 'Magmortar', 'Leafeon', 'Glaceon', 'Porygon-Z',
			'Gallade', 'Froslass', 'Rotom', 'Rotom-Heat', 'Rotom-Wash',
			'Rotom-Frost', 'Rotom-Fan', 'Rotom-Mow', 'Dialga', 'Dialga-Origin',
			'Palkia', 'Palkia-Origin', 'Giratina', 'Giratina-Origin', 'Shaymin',
			'Shaymin-Sky', 'Arceus', 'Victini', 'Snivy', 'Servine',
			'Serperior', 'Tepig', 'Pignite', 'Emboar', 'Patrat',
			...
			'Tranquill', 'Unfezant', 'Blitzle', 'Zebstrika', 'Woobat',
			'Swoobat', 'Drilbur', 'Excadrill', 'Audino', 'Timburr',
			'Gurdurr', 'Conkeldurr', 'Throh', 'Sawk', 'Sewaddle',
			'Swadloon', 'Leavanny', 'Venipede', 'Whirlipede', 'Scolipede',
			'Cottonee', 'Whimsicott', 'Petilil', 'Lilligant', 'Lilligant-Hisui',
			'Darumaka-Galar', 'Darmanitan-Galar', 'Darmanitan-Galar-Zen', 'Scraggy', 'Scrafty',
			'Trubbish', 'Garbodor', 'Zorua', 'Zorua-Hisui', 'Zoroark',
			'Zoroark-Hisui', 'Minccino', 'Cinccino', 'Solosis', 'Duosion',
			'Reuniclus', 'Deerling', 'Sawsbuck', 'Emolga', 'Karrablast',
			'Escavalier', 'Foongus', 'Amoonguss', 'Joltik', 'Galvantula',
			'Ferroseed', 'Ferrothorn', 'Klink', 'Klang', 'Klinklang',
			'Litwick', 'Lampent', 'Chandelure', 'Axew', 'Fraxure',
			'Haxorus', 'Shelmet', 'Accelgor', 'Mienfoo', 'Mienshao',
			'Druddigon', 'Pawniard', 'Bisharp', 'Bouffalant', 'Vullaby',
			'Mandibuzz', 'Heatmor', 'Durant', 'Deino', 'Zweilous',
			'Hydreigon', 'Larvesta', 'Volcarona', 'Cobalion', 'Terrakion',
			'Virizion', 'Tornadus', 'Tornadus-Therian', 'Thundurus', 'Thundurus-Therian',
			'Reshiram', 'Zekrom', 'Landorus', 'Landorus-Therian', 'Kyurem-White',
			'Kyurem-Black', 'Keldeo', 'Keldeo-Resolute', 'Meloetta', 'Meloetta-Pirouette',
			'Genesect', 'Chespin', 'Quilladin', 'Chesnaught', 'Fennekin',
			'Braixen', 'Delphox', 'Bunnelby', 'Diggersby', 'Fletchling',
			...
			'Espurr', 'Meowstic', 'Meowstic-F', 'Honedge', 'Doublade',
			'Aegislash', 'Spritzee', 'Aromatisse', 'Swirlix', 'Slurpuff',
			'Helioptile', 'Heliolisk', 'Sylveon', 'Hawlucha', 'Dedenne',
			'Klefki', 'Phantump', 'Trevenant', 'Pumpkaboo', 'Pumpkaboo-Small',
			'Pumpkaboo-Large', 'Pumpkaboo-Super', 'Gourgeist', 'Gourgeist-Small', 'Gourgeist-Large',
			'Gourgeist-Super', 'Noibat', 'Noivern', 'Xerneas', 'Yveltal',
			'Zygarde', 'Zygarde-10%', 'Zygarde-50%', 'Zygarde-Complete', 'Hoopa',
			'Hoopa-Unbound', 'Volcanion', 'Rowlet', 'Dartrix', 'Decidueye',
			'Decidueye-Hisui', 'Litten', 'Torracat', 'Incineroar', 'Pikipek',
			'Trumbeak', 'Toucannon', 'Yungoos', 'Gumshoos', 'Grubbin',
			'Charjabug', 'Vikavolt', 'Oricorio', 'Oricorio-Pom-Pom', "Oricorio-Pa'u",
			'Oricorio-Sensu', 'Cutiefly', 'Ribombee', 'Mudbray', 'Mudsdale',
			'Formantis', 'Lurantis', 'Morelull', 'Shiinotic', 'Salandit',
			'Salazzle', 'Stufful', 'Bewear', 'Bounsweet', 'Steenee',
			'Tsareena', 'Oranguru', 'Passimian', 'Type: Null', 'Silvally',
			'Komala', 'Togedemaru', 'Mimikyu', 'Drampa', 'Jangmo-o',
			'Hakamo-o', 'Kommo-o', 'Solgaleo', 'Lunala', 'Pheromosa',
			'Necrozma-Dusk-Mane', 'Necrozma-Dawn-Wings', 'Necrozma-Ultra', 'Magearna', 'Marshadow',
			'Naganadel', 'Zeraora', 'Meltan', 'Melmetal', 'Grookey',
			'Thwackey', 'Rillaboom', 'Scorbunny', 'Raboot', 'Cinderace',
			'Skwovet', 'Greedent', 'Rookidee', 'Corvisquire', 'Corviknight',
			'Blipbug', 'Dottler', 'Orbeetle', 'Nickit', 'Thievul',
			'Gossifleur', 'Eldegoss', 'Wooloo', 'Dubwool', 'Yamper',
			'Boltund', 'Applin', 'Flapple', 'Appletun', 'Toxel',
			'Toxtricity', 'Toxtricity-Low-Key', 'Sizzlipede', 'Centiskorch', 'Sinistea',
			'Polteageist', 'Hatenna', 'Hattrem', 'Hatterene', 'Impidimp',
			'Morgrem', 'Grimmsnarl', 'Obstagoon', 'Sirfetch\u2019d', 'Mr. Rime',
			'Milcery', 'Alcremie', 'Snom', 'Frosmoth', 'Indeedee',
			'Indeedee-F', 'Morpeko', 'Cufant', 'Copperajah', 'Duraludon',
			'Zacian', 'Zacian-Crowned', 'Zamazenta', 'Zamazenta-Crowned', 'Eternatus',
			'Urshifu', 'Urshifu-Rapid-Strike', 'Zarude', 'Glastrier', 'Spectrier',
			'Calyrex', 'Calyrex-Ice', 'Calyrex-Shadow', 'Wyrdeer', 'Kleavor',
			'Ursaluna-Bloodmoon', 'Sneasler', 'Enamorus', 'Enamorus-Therian', 'Sprigatito',
			'Floragato', 'Meowscarada', 'Lechonk', 'Oinkologne', 'Oinkologne-F',
			'Tarountula', 'Spidops', 'Nymble', 'Lokix', 'Pawmi',
			'Pawmo', 'Pawmot', 'Tandemaus', 'Maushold', 'Fidough',
			'Dachsbun', 'Smoliv', 'Dolliv', 'Arboliva', 'Squawkabilly',
			'Charcadet', 'Armarouge', 'Ceruledge', 'Maschiff', 'Mabosstiff',
			'Shroodle', 'Grafaiai', 'Toedscool', 'Toedscruel', 'Rellor',
			'Rabsca', 'Flittle', 'Espathra', 'Tinkatink', 'Tinkatuff',
			'Tinkaton', 'Palafin', 'Palafin-Hero', 'Varoom', 'Revaroom',
			'Cyclizar', 'Orthworm', 'Greavard', 'Houndstone', 'Annihilape',
			'Farigiraf', 'Kingambit', 'Flutter Mane', 'Iron Treads', 'Iron Bundle',
			'Iron Hands', 'Iron Jugulis', 'Iron Moth', 'Iron Thorns', 'Frigibax',
			'Arctibax', 'Baxcalibur', 'Gimmighoul', 'Gimmighoul-Roaming', 'Gholdengo',
			'Chien-Pao', 'Chi-Yu', 'Iron Valiant', 'Koraidon', 'Miraidon',
			'Iron Leaves', 'Dipplin', 'Okidogi', 'Munkidori', 'Fezandipiti',
			'Ogerpon', 'Ogerpon-Wellspring', 'Ogerpon-Hearthflame', 'Ogerpon-Cornerstone', 'Archaludon',
			'Hydrapple', 'Iron Boulder', 'Iron Crown', 'Pecharunt', 'Venusaur-Mega',
			'Charizard-Mega-X', 'Charizard-Mega-Y', 'Blastoise-Mega', 'Alakazam-Mega', 'Gengar-Mega',
			'Kangaskhan-Mega', 'Pinsir-Mega', 'Gyarados-Mega', 'Aerodactyl-Mega', 'Mewtwo-Mega-X',
			'Mewtwo-Mega-Y', 'Ampharos-Mega', 'Heracross-Mega', 'Houndoom-Mega', 'Tyranitar-Mega',
			'Blaziken-Mega', 'Gardevoir-Mega', 'Mawile-Mega', 'Aggron-Mega', 'Medicham-Mega',
			'Manectric-Mega', 'Banette-Mega', 'Absol-Mega', 'Latias-Mega', 'Latios-Mega',
			'Garchomp-Mega', 'Lucario-Mega', 'Abomasnow-Mega', 'Beedrill-Mega', 'Pidgeot-Mega',
			'Slowbro-Mega', 'Steelix-Mega', 'Sceptile-Mega', 'Swampert-Mega', 'Sableye-Mega',
			'Sharpedo-Mega', 'Camerupt-Mega', 'Altaria-Mega', 'Glalie-Mega', 'Salamence-Mega',
			'Metagross-Mega', 'Kyogre-Primal', 'Groudon-Primal', 'Rayquaza-Mega', 'Lopunny-Mega',
			'Gallade-Mega', 'Audino-Mega', 'Diancie-Mega', 'Venusaurite', 'Charizardite X',
			'Charizardite Y', 'Blastoisinite', 'Alakazite', 'Gengarite', 'Kangaskhanite',
			'Pinsirite', 'Gyaradosite', 'Aerodactylite', 'Mewtwonite X', 'Mewtwonite Y',
			'Ampharosite', 'Scizorite', 'Heracronite', 'Houndoominite', 'Tyranitarite',
			'Blazikenite', 'Gardevoirite', 'Mawilite', 'Aggronite', 'Medichamite',
			'Manectite', 'Banettite', 'Absolite', 'Latiasite', 'Latiosite',
			'Garchompite', 'Lucarionite', 'Abomasite', 'Beedrillite', 'Pidgeotite',
			'Slowbronite', 'Steelixite', 'Sceptilite', 'Swampertite', 'Sablenite',
			'Sharpedonite', 'Cameruptite', 'Altarianite', 'Glalitite', 'Salamencite',
			'Metagrossite', 'Blue Orb', 'Red Orb', 'Lopunnite', 'Galladite',
			'Audinite', 'Diancite', 'Normalium Z', 'Fightinium Z', 'Flyinium Z',
			'Poisonium Z', 'Groundium Z', 'Rockium Z', 'Buginium Z', 'Ghostium Z',
			'Steelium Z', 'Firium Z', 'Waterium Z', 'Grassium Z', 'Electrium Z',
			'Psychium Z', 'Icium Z', 'Dragonium Z', 'Darkinium Z', 'Fairium Z',
			'Pikanium Z', 'Pikashunium Z', 'Aloraichium Z', 'Eevium Z', 'Snorlium Z',
			'Mewnium Z', 'Decidium Z', 'Incinium Z', 'Primarium Z', 'Lycanium Z',
			'Mimikium Z', 'Kommonium Z', 'Tapunium Z', 'Solganium Z', 'Lunalium Z',
			'Ultranecrozium Z', 'Marshadium Z', 'Terapagos', 'Pikachu-Partner', 'Eevee-Starter'
		],
		unbanlist: ['Gouging Fire'],
	},
	{
		name: "[Gen 9] Fossil Fishing Doubles",
		mod: 'gen9',
		gameType: 'doubles',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Evasion Abilities Clause', 'Gravity Sleep Clause'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
			'Quick Claw', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail',
			'Charmander', 'Charmeleon', 'Charizard', 'Caterpie', 'Metapod',
			...
			'Mimikium Z', 'Kommonium Z', 'Tapunium Z', 'Solganium Z', 'Lunalium Z',
			'Ultranecrozium Z', 'Marshadium Z', 'Terapagos', 'Pikachu-Partner', 'Eevee-Starter',
			'Coaching', 'Dark Void', 'Swagger', 'Commander'
		],
		unbanlist: ['Gouging Fire'],
	},
